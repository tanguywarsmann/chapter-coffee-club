-- Génération de lectures complètes pour les 30 comptes factices
DO $$
DECLARE
...
BEGIN
    ...
    SELECT array_agg(id::uuid) INTO books_array 
    FROM books 
    ...
    LOOP
        ...
        LOOP
            ...
            FROM books WHERE id::text = book_id::text;
    ...
    RAISE NOTICE 'Données de lecture générées avec succès pour les 30 profils factices';
END $$;