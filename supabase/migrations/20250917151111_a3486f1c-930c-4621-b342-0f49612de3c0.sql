...
-- 1. Re-enable RLS on tables that have policies but RLS disabled
ALTER TABLE reading_progress ENABLE ROW LEVEL SECURITY;
ALTER TABLE reading_validations ENABLE ROW LEVEL SECURITY;

-- 2. Fix function search path issues - add SET search_path to existing functions
