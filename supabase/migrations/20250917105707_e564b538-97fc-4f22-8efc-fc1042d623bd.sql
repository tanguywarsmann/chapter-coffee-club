-- Remplace la RPC et évite l'ambiguïté sur "segment" :
--  - On renomme la colonne de sortie en validated_segment
--  - On utilise ON CONFLICT ON CONSTRAINT (au lieu d'énumérer les colonnes)
--  - On prefixe explicitement les colonnes quand pertinent
...
-- Sécurité bêta (si pas déjà fait)
