...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-normal break-words text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-auto min-h-[44px] px-6 py-3 rounded-xl text-base sm:text-sm sm:min-h-10 sm:px-4 sm:py-2",
        sm: "h-auto min-h-[40px] px-4 py-2 rounded-lg text-sm sm:h-9 sm:px-3",
        lg: "h-auto min-h-[48px] px-8 py-4 rounded-xl text-lg sm:h-11 sm:px-8 sm:text-base",
