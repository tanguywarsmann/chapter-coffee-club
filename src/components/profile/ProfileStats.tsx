...
export function ProfileStats({ stats }: ProfileStatsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col space-y-1">
              ...
              <div className="flex items-center">
                ...
                <span className="text-h3 font-medium text-coffee-darker">{stats.booksRead}</span>
              </div>
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-body-sm text-muted-foreground">En cours</span>
              <div className="flex items-center">
                <BookOpen className="h-4 w-4 mr-1 text-coffee-dark" />
                <span className="text-h3 font-medium text-coffee-darker">{stats.booksInProgress}</span>
              </div>
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-body-sm text-muted-foreground">Pages lues</span>
              <span className="text-h3 font-medium text-coffee-darker">{stats.totalPages}</span>
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-body-sm text-muted-foreground">{getBadgesText()}</span>
              <div className="flex items-center">
                <Award className="h-4 w-4 mr-1 text-coffee-dark" />
                <span className="text-h3 font-medium text-coffee-darker">{stats.badgesEarned}</span>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="border-coffee-light">
        <CardHeader className="pb-2">
          <CardTitle className="text-h4 font-serif text-coffee-darker">Activité récente</CardTitle>
          <CardDescription>Vos habitudes de lecture</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col space-y-1">
              <span className="text-body-sm text-muted-foreground">Série actuelle</span>
              <div className="flex items-center">
                <CalendarDays className="h-4 w-4 mr-1 text-coffee-dark" />
                <span className="text-h3 font-medium text-coffee-darker">{getStreakText()}</span>
              </div>
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-body-sm text-muted-foreground">Temps de lecture</span>
              <div className="flex items-center">
                <Clock className="h-4 w-4 mr-1 text-coffee-dark" />
                <span className="text-h3 font-medium text-coffee-darker">{stats.readingHours}h</span>
              </div>
            </div>
          </div>
          <div className="mt-4">
            <h4 className="text-body-sm font-medium text-coffee-darker mb-2">Cette semaine</h4>
