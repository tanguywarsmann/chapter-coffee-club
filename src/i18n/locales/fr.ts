export const fr = {
	...
	landing: {
		...
		description:
			"En moyenne, sur 10 livres achetés, on finit seulement 2 livres.",
		stravaBadge: "🏃 Le Strava de la lecture",
		...
		valueSection: {
			...
			without1: "Lecture déclarative, personne ne vérifie",
			without2: "Pas de feedback, motivation qui s'essouffle",
			without3: "Aucun effet social",
			withTitle: "Avec VREAD",
			with1: "Lecture certifiée et vérifiable",
	...
	reading: {
		...
		quiz: {
			title: "Valider un segment",
			subtitle: "Répondez en un mot pour valider votre compréhension.",
			segmentLabel: "Segment",
			segmentHint: "Environ 30 pages, variable selon l'édition",
			placeholder: "Réponse en un mot",
			cancel: "Annuler",
			validate: "Valider",
			validating: "Validation…",
			emptyAnswer: "Veuillez entrer une réponse",
			mustBeLoggedIn: "Vous devez être connecté pour valider",
			bookLookupError: "Erreur lors de la recherche du livre.",
			segmentValidated: "✅ Segment validé !",
			segmentValidatedDesc: "+10 XP • Prochain segment dans ~30 pages",
			incorrectAnswer: "Réponse incorrecte",
			attemptsRemaining: "tentative(s) restante(s)",
			attempts: "tentatives",
			jokersUnavailable: "Jokers indisponibles",
			jokersUnavailableDesc: "Livre trop court (< 3 segments)",
			attemptsExhausted: "Tentatives épuisées",
			attemptsExhaustedDesc: "Réessayez plus tard",
			cancelAriaLabel: "Annuler le quiz de lecture",
			validateAriaLabel: "Valider ma réponse au quiz",
			answerRequired: "Vous devez saisir une réponse avant de valider",
			segmentValidatedTitle: "validé",
			useJoker: "Utiliser un joker",
			jokerDesc: "Révèle la bonne réponse pour ce segment en dépensant un joker.",
			jokerWarning: "Utiliser un joker révélera immédiatement la bonne réponse et validera ce segment.",
			jokersRemaining: "Jokers restants",
			segment: "Segment",
			jokerSuccess: "Joker utilisé ! La bonne réponse est révélée.",
			jokerError: "Erreur lors de l'utilisation du joker. Veuillez réessayer.",
			jokerUnavailableShort: "Jokers indisponibles sur ce livre (moins de 3 segments).",
			jokerMissingData: "Impossible d'afficher la bonne réponse (données manquantes).",
		},
	},
	...
	common: {
		...
		bookNotAvailableDescription:
			"Le livre demandé n'est pas disponible pour le moment.",
	...
	premium: {
		...
		earlyBirdDesc:
			"Accès illimité à la demande de livres + toutes les fonctionnalités premium sans limite de temps. Offre de lancement à vie - Paiement unique, bénéfices permanents.",
		...
		faq: {
			...
			howItWorks: {
				...
				answer:
					"Une fois Premium, tu peux demander n'importe quel livre via le formulaire dédié. Nous créons les questions de compréhension et ajoutons le livre ASAP.",
			},
			howMany: {
	...
	requestBook: {
		...
		paywall: {
			...
			description:
				"Passe Premium pour demander l'ajout de n'importe quel livre dans VREAD. Nous créons les questions de compréhension et ajoutons le livre sous 48-72h.",
		...
		form: {
			...
			reasonPlaceholder:
				"Ex: Classique de la littérature française que je veux lire pour mes études",
		...
		toast: {
			...
			success:
				"Nous traiterons ta demande sous 48-72h. Tu seras notifié par email.",
	...
	discover: {
		...
		readersTitle: "Lecteurs à découvrir",
		suggestionsTitle: "Suggestions",
		search: {
			placeholder: "Rechercher un lecteur…",
			searching: "Recherche…",
			noResults: "Aucun lecteur trouvé.",
		},
	},
