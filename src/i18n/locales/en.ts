...
export const en: Translations = {
  ...
  landing: {
    ...
    hero: {
      ...
      titleEnd: " read",
      subtitle: "VREAD certifies your reading with adaptive quizzes and rewards you with exclusive badges. Join 3000+ passionate readers.",
      ctaPrimary: "Start the adventure",
      ctaAvailability: "Free • Available on iOS and Android",
      desktopLink: "Access the site on desktop",
      xpEarned: "XP Earned",
    },
    features: {
  ...
  reading: {
    ...
    quiz: {
      ...
      subtitle: "Answer in one word to confirm your understanding.",
      segmentLabel: "Segment",
      segmentHint: "Around 30 pages, may vary by edition",
      placeholder: "Answer in one word",
      cancel: "Cancel",
      validate: "Validate",
      validating: "Validating…",
      emptyAnswer: "Please enter an answer",
      mustBeLoggedIn: "You must be logged in to validate",
      bookLookupError: "Error looking up the book.",
      segmentValidated: "✅ Segment validated!",
      segmentValidatedDesc: "+10 XP • Next segment in ~30 pages",
      incorrectAnswer: "Incorrect answer",
      attemptsRemaining: "attempt(s) remaining",
      attempts: "attempts",
      jokersUnavailable: "Jokers unavailable",
      jokersUnavailableDesc: "Book too short (< 3 segments)",
      attemptsExhausted: "Attempts exhausted",
      attemptsExhaustedDesc: "Try again later",
      cancelAriaLabel: "Cancel reading quiz",
      validateAriaLabel: "Submit quiz answer",
      answerRequired: "You must enter an answer before validating",
      segmentValidatedTitle: "validated",
      useJoker: "Use a joker",
      jokerDesc: "Reveals the correct answer for this segment by spending a joker.",
      jokerWarning: "Using a joker will immediately reveal the correct answer and validate this segment.",
      jokersRemaining: "Jokers remaining",
      segment: "Segment",
      jokerSuccess: "Joker used! The correct answer is revealed.",
      jokerError: "Error using joker. Please try again.",
      jokerUnavailableShort: "Jokers unavailable for this book (fewer than 3 segments).",
      jokerMissingData: "Unable to display the correct answer (missing data).",
    },
  },
