  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Prouve que tu lis. Question tous les 30 pages. Stats, streak, badges."
        />
      </Helmet>
        ...
        <section className="min-h-screen flex items-center justify-center px-4">
          <div className="max-w-4xl text-center space-y-12">
            ...
            <div className="space-y-6">
              <Button 
                size="lg" 
                className="bg-reed-light px-16 py-8 text-2xl font-bold text-reed-darker hover:bg-white transition-all duration-200"
                asChild
              >
