...
export default function ExportPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-white text-black">
        <h1 className="text-h3 font-bold">Vérification des permissions...</h1>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-white text-black">
        <h1 className="text-h3 font-bold">Accès non autorisé</h1>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-white text-black">
      <h1 className="text-h3 font-bold">Export de la base VREAD</h1>
