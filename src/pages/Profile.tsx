                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-shrink-0">
                  ...
                  {isOwnProfile && !isEditingProfile && (
                    <Button
                      variant="outline"
                      size="sm"
                      className="mb-4 border-coffee-light hover:bg-coffee-light/20 text-caption sm:text-body-sm"
                  ...
                  {isEditingProfile && isOwnProfile ? (
                    ...
                    <>
                      <div className="min-w-0">
                        <h1 className="text-h3 sm:text-h2 lg:text-h1 font-serif font-bold text-coffee-darker mb-2 break-words">
                          {displayName}
                        </h1>
                        <p className="text-coffee-medium text-body-sm sm:text-body lg:text-body-lg break-all">
                          {profileData?.email || user?.email}
                        </p>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                        ...
                        >
                          ...
                          <span className="font-semibold text-coffee-darker text-body-sm sm:text-body lg:text-body-lg">{followerCounts.followers}</span>
                          <span className="text-coffee-medium group-hover:underline text-body-sm sm:text-body hidden sm:inline">Abonnés</span>
                          <span className="text-coffee-medium group-hover:underline text-caption sm:hidden">Abonnés</span>
                        </Link>
                        <Link
                        ...
                        >
                          <Users className="h-4 w-4 sm:h-5 sm:w-5 text-coffee-dark flex-shrink-0" />
                          <span className="font-semibold text-coffee-darker text-body-sm sm:text-body lg:text-body-lg">{followerCounts.following}</span>
                          <span className="text-coffee-medium group-hover:underline text-body-sm sm:text-body hidden sm:inline">Abonnements</span>
                          <span className="text-coffee-medium group-hover:underline text-caption sm:hidden">Suivis</span>
                        </Link>
                        ...
                        {isOwnProfile && (
                          <div className="flex-shrink-0">
                            <Link
                              ...
                              className="text-caption text-muted-foreground hover:text-destructive transition-colors underline-offset-4 hover:underline"
                            >
                      ...
                      {isOwnProfile && (
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
                          <div className="text-center p-2 sm:p-3 bg-coffee-light/20 rounded-lg min-w-0">
                            ...
                            <div className="text-h4 sm:text-h3 font-bold text-coffee-darker">{stats.booksRead}</div>
                            <div className="text-caption sm:text-body-sm text-coffee-medium break-words">Livres terminés</div>
                          </div>
                          <div className="text-center p-2 sm:p-3 bg-coffee-light/20 rounded-lg min-w-0">
                            <Target className="h-4 w-4 sm:h-6 sm:w-6 text-coffee-dark mx-auto mb-1" />
                            <div className="text-h4 sm:text-h3 font-bold text-coffee-darker">{stats.segmentsValidated}</div>
                            <div className="text-caption sm:text-body-sm text-coffee-medium">Validations</div>
                          </div>
                          <div className="text-center p-2 sm:p-3 bg-coffee-light/20 rounded-lg min-w-0">
                            <Clock className="h-4 w-4 sm:h-6 sm:w-6 text-coffee-dark mx-auto mb-1" />
                            <div className="text-h4 sm:text-h3 font-bold text-coffee-darker">{Math.floor(stats.readingTime / 60)}h</div>
                            <div className="text-caption sm:text-body-sm text-coffee-medium break-words">Temps de lecture</div>
                          </div>
                          <div className="text-center p-2 sm:p-3 bg-coffee-light/20 rounded-lg min-w-0">
                            <TrendingUp className="h-4 w-4 sm:h-6 sm:w-6 text-coffee-dark mx-auto mb-1" />
                            <div className="text-h4 sm:text-h3 font-bold text-coffee-darker">{stats.totalPages}</div>
                            <div className="text-caption sm:text-body-sm text-coffee-medium">Pages lues</div>
                          </div>
                        </div>
                      )}
                    </>
          ...
          <Tabs defaultValue="overview" className="space-y-4 sm:space-y-6 w-full">
            ...
            <div className="w-full overflow-x-auto scrollbar-hide">
              <TabsList className="bg-white/80 backdrop-blur-sm border border-coffee-light/50 p-1 inline-flex min-w-full sm:min-w-0 justify-start sm:justify-center">
                <TabsTrigger
                  value="overview"
                  className="data-[state=active]:bg-coffee-light data-[state=active]:text-coffee-darker text-caption sm:text-body-sm px-2 sm:px-3 py-1.5 sm:py-2 whitespace-nowrap"
                >
                      ...
                      {currentBooks.slice(0, 2).map((book) => (
                        <div key={book.id} className="flex gap-3 sm:gap-4 p-3 sm:p-4 bg-coffee-light/10 rounded-lg overflow-hidden">
                          ...
                          <div className="flex-1 space-y-2 min-w-0">
                            <h4 className="font-medium text-coffee-darker text-body-sm sm:text-body break-words line-clamp-2">{book.book_title}</h4>
                            <p className="text-caption sm:text-body-sm text-coffee-medium break-words line-clamp-1">{book.book_author}</p>
                            <Progress value={book.progressPercent || 0} className="h-1.5 sm:h-2" />
                            <p className="text-caption text-coffee-medium">
              ...
              {badges.length > 0 && (
                <Card className="border-coffee-light/50 bg-white/80 backdrop-blur-sm overflow-hidden">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 sm:pb-4">
                    <CardTitle className="text-h4 font-serif text-coffee-darker flex items-center gap-2 min-w-0">
                      <Award className="h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0" />
                      <span className="break-words">{t.common.recentBadges}</span>
                    </CardTitle>
                    <Button variant="outline" size="sm" asChild className="flex-shrink-0 text-caption sm:text-body-sm">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 sm:gap-4">
                      {badges.map((badge) => (
                        <div key={badge.id} className="text-center group">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-coffee-light to-coffee-medium rounded-full mx-auto mb-2 flex items-center justify-center text-h4 sm:text-h3 group-hover:scale-110 transition-transform">
                            {badge.icon || "🏆"}
                          </div>
                          <p className="text-caption text-coffee-darker font-medium line-clamp-2 break-words">
                            {badge.label}
                          </p>
                        </div>
                      ))}
            ...
            <TabsContent value="books" className="space-y-4 sm:space-y-6 mt-0">
              <Card className="border-coffee-light/50 bg-white/80 backdrop-blur-sm overflow-hidden">
                <CardHeader className="pb-3 sm:pb-4">
                  <CardTitle className="text-h4 font-serif text-coffee-darker break-words">
                ...
                <CardContent className="pt-0">
                  {completedBooks.length > 0 ? (
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3 sm:gap-4">
                      {completedBooks.map((book) => (
                        ...
                        >
                          ...
                          <p className="text-caption text-coffee-darker font-medium mt-2 line-clamp-2 break-words">
                            {book.book_title}
                          </p>
                        </Link>
                      ))}
                    ...
                    <div className="text-center py-8 sm:py-12 text-coffee-medium">
                      <p className="text-body-sm sm:text-body">Aucun livre terminé pour le moment</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                      {badges.map((badge) => (
                        <div key={badge.id} className="text-center p-3 sm:p-4 bg-coffee-light/10 rounded-lg">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-coffee-light to-coffee-medium rounded-full mx-auto mb-3 flex items-center justify-center text-h3 sm:text-h2">
                            {badge.icon || "🏆"}
                          </div>
                          <h4 className="font-medium text-coffee-darker mb-1 text-body-sm sm:text-body break-words">{badge.label}</h4>
                          <p className="text-caption sm:text-body-sm text-coffee-medium line-clamp-2 break-words">{badge.description}</p>
                        </div>
                      ))}
                    </div>
                  ) : (
                    <div className="text-center py-8 sm:py-12 text-coffee-medium">
                      <p className="text-body-sm sm:text-body">Aucun badge obtenu pour le moment</p>
                    </div>
                  )}
                </CardContent>
              </Card>
