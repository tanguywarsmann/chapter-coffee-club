    ...
    <>
      ...
      <main className="container mx-auto px-4 py-10 max-w-4xl">
        <div className="prose prose-neutral max-w-none">
          <h1 className="text-3xl font-bold mb-6">VREAD</h1>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Orthographe</h2>
          <p className="mb-6">
            Le nom s'écrit VREAD.
          </p>
